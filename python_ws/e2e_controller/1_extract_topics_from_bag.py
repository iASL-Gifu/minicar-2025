...
if __name__ == '__main__':
    ...
    parser.add_argument('-b', '--bags_dir', required=True, help='Path to directory containing rosbag folders')
    parser.add_argument('-o', '--outdir', required=True, help='Output root directory')
